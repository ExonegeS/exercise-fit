    ...
    return (
        <div className='p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 sm:items-center gap-2'>
                ...
                <button onClick={handleSetIncrement} className={"flex flex-col p-2 rounded border-[2.5px] border-solid w-full duration-200" + (setsCompleted < 5 ? setsCompleted > 0 ? ' border-yellow-900 hover:border-yellow-600' : ' border-blue-900 hover:border-blue-600' : ' border-green-900 hover:border-green-600')}>
